...
const Navbar = () => {
  ...
  const navigation = [
    ...
    { name: 'NFT-MARKITPLACE', href: '/nft', current: false },
          ...
          <div className="px-2 absolute w-full">
            <div className="relative flex items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center lg:items-center lg:justify-between ml-[20px]">
                ...
                <div className='nav-cutting-parent bg-[#ffc400] h-[44px] flex items-center lg:w-[60%] z-10'>
                    ...
                    <div className="grid grid-cols-5 text-center">
                      {navigation.map((item) => (
                        <a
                          key={item.name}
                          href={item.href}
                          className=' text-[15px] font-medium text-white hover:bg-[#ffc400] hover:text-black py-2.5 h-full'
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="relative flex rounded-full text-sm">
                      ...
                      <div className='cont_wallet-btn-parent bg-[#EC9C2E] h-[70px] z-10'>
                        <button className='cont_wallet-btn sm:px-10 py-2 md:text-xl h-[70px] text-[10px] font-medium text-black w-full bg-[#ffc400]'> Connect Wallet </button>
                      </div>
                    </Menu.Button>
                  </div>
                  <Transition
